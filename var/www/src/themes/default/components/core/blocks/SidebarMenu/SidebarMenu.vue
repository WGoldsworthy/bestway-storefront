      ...
      <div class="col-xs-12 h4 sans-serif">
        <ul class="p0 m0 relative sidebar-menu__list" :style="mainListStyles">
          <li @click="closeMenu" class="brdr-bottom-1 brdr-cl-bg-secondary bg-cl-primary">
            <router-link
              class="block px25 py10 cl-accent no-underline"
              :to="localizedRoute('/')"
              exact
            >
              {{ $t('Home') }}
          ...
          >
            <div v-if="isCurrentMenuShowed" class="subcategory-item">
              ...
              <router-link
                v-else
                class="px25 py10 cl-accent no-underline col-xs"
          ...
          <li @click="closeMenu" v-if="isCurrentMenuShowed" class="bg-cl-secondary">
            <router-link
              class="block px25 py10 brdr-bottom-1 brdr-cl-secondary cl-accent no-underline fs-medium-small bold"
          ...
          <li @click="login" class="brdr-bottom-1 brdr-cl-secondary bg-cl-secondary flex">
            ...
            <a
              ...
              class="block w-100 px25 py10 cl-accent no-underline fs-medium-small"
            >
              {{ $t('My Account') }}
            </a>
          </li>
          <li @click="closeMenu" v-if="isCurrentMenuShowed" class="bg-cl-secondary">
            <router-link
              class="block px25 py10 brdr-bottom-1 brdr-cl-secondary cl-accent no-underline fs-medium-small"
              :to="localizedRoute('/sale')"
              exact
            >
              {{ $t('Category Advice') }}
