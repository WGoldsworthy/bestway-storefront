      ...
      <div class="container">
        <section class="row m0 between-xs">
          ...
          <div class="col-xs-12 col-md-5 data">
            ...
            <p
              class="low-stock"
              v-if="product.stock.qty < 50 && product.stock.qty > 0"
            >
              Low in Stock
            </p>
            <p
              class="no-stock"
              v-if="product.stock.qty === 0"
            >
              Out of Stock
            </p>
            <div class="mb20 uppercase cl-secondary">
              ...
              <span v-if="product.pack_size">Unit size: {{ product.pack_size }} </span><br>
              <span v-if="product.number">No. of units: {{ product.number }} </span>
            </div>
            <div itemprop="offers" itemscope itemtype="http://schema.org/Offer">
              ...
              <div
                ...
                v-if="(product.type_id !== 'grouped' && currentUser) && typeof product.tier_prices == 'undefined'"
              >
                <div
              ...
              <div v-else-if="typeof product.tier_prices !== 'undefined' && currentUser" class="mb40 price serif">
                <div class="h3 cl-secondary">
                  <span class="cl-mine-shaft h2 weight-700">
                    £{{ (getTierPrice() * product.qty).toFixed(2) }}
                  </span>
                </div>
              </div>
              <div
            ...
            <div v-if="currentUser" class="row m0">
              <add-to-cart
                :product="product"
            ...
            <div v-else class="row m0">
              <button-full
                class="col-xs-12 col-sm-4 col-md-6"
                disabled>Sign in to add to cart
              </button-full>
            </div>
...
export default {
  ...
  methods: {
    ...
    getTierPrice () {
      if (typeof this.product.tier_prices !== 'undefined' && this.currentUser) {
        var parent = this;
